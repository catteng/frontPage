              ...
              <div id="leftContent">
                ...
                <div id="name_blood" className="row  align-items-center">
                  ...
                  <div id="blood" className=" align-items-center d-flex">
                    <img id="bloodRate" src={`/Images/first_page/bloodRateRed.svg`} alt=""></img>
                    <img id="bloodRate" src={`/Images/first_page/bloodRateRed.svg`}alt=""></img>
                    <img id="bloodRate" src={`/Images/first_page/bloodRateRed.svg`}alt=""></img>
                    <img id="bloodRate" src={`/Images/first_page/bloodRateRed.svg`} alt=""></img>
                    <img id="bloodRate" src={`/Images/first_page/bloodRateWhite.svg`} alt=""></img>
                  </div>
                </div>
